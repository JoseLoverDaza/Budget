namespace CORE.Services
{
    ...
    public class UserBudgetService : BaseService, IUserBudgetService
    {
        ...
        public UserBudgetExtendDto? GetUserBudgetByIdUserBudget(UserBudgetDto userBudget)
        {
            ...
            _logApiService.TraceLog(typeof(UserBudget).Name, Constants.EntityAction.CONSULT, JsonSerializer.Serialize(Constants.General.JSON_EMPTY), JsonSerializer.Serialize(Constants.General.JSON_EMPTY), Json.SerializeWithoutNulls(userBudget), DateTime.Now, null);
        ...
        public UserBudgetDto SaveUserBudget(UserBudgetDto userBudget)
        {
            ...
            _logApiService.TraceLog(typeof(UserBudget).Name, Constants.EntityAction.SAVE, JsonSerializer.Serialize(Constants.General.JSON_EMPTY), JsonSerializer.Serialize(saveUserBudget), JsonSerializer.Serialize(Constants.General.JSON_EMPTY), DateTime.Now, null);
        ...
        public UserBudgetDto UpdateUserBudget(UserBudgetDto userBudget)
        {
            ...
            _logApiService.TraceLog(typeof(UserBudget).Name, Constants.EntityAction.UPDATE, JsonSerializer.Serialize(userBudgetSearch), JsonSerializer.Serialize(updateUserBudget), JsonSerializer.Serialize(Constants.General.JSON_EMPTY), DateTime.Now, null);
        ...
        public UserBudgetDto DeleteUserBudget(UserBudgetDto userBudget)
        {
            ...
            _logApiService.TraceLog(typeof(UserBudget).Name, Constants.EntityAction.DELETE, JsonSerializer.Serialize(userBudgetSearch), JsonSerializer.Serialize(deleteUserBudget), JsonSerializer.Serialize(Constants.General.JSON_EMPTY), DateTime.Now, null);
